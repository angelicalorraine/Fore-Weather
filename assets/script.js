...
async function displayWeather() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&units=imperial&appid=6e5dd978f10ad44dc4fa36386d4e8fdb";
    ...
    var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=6e5dd978f10ad44dc4fa36386d4e8fdb&lat=" + getLat + "&lon=" + getLong;
...
async function displayFiveDayForecast() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q=" + cityname + "&units=imperial&appid=6e5dd978f10ad44dc4fa36386d4e8fdb";
    ...
    var cardDeck = $("<div class='card-deck col-md-12 '>");
    forecastDiv.append(cardDeck);

    console.log(response);
    for (i = 0; i < 5; i++) {
        var forecastCard = $("<div class='card col col-md-12 mb-3 mt-3'>");
